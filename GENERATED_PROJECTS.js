...
const projects = [
    {
        ...
        content: `<h3>Web Dashboard</h3><p>Optimized UI performance by 40% using advanced memoization patterns.</p><p><strong>Stack:</strong> React, Vite, TypeScript</p>`
    },
    {
        id: 'ai-orchestrator',
        ...
        content: `<h3>AI Orchestrator</h3><p>Automated complex multi-step tasks using LangGraph and custom agents.</p><p><strong>Stack:</strong> Python, FastAPI</p>`
    },
    {
        id: 'resume',
        title: 'My Resume',
        ...
        content: `<h3>Jane Doe - Resume</h3>
        <hr>
        <p><strong>Roles:</strong> Full-Stack Engineer, Python Developer, React Specialist</p>
        <hr>
        <p><strong>Summary:</strong> Full-Stack Engineer specialized in React and Python. Refined through the Scientific Makeover process.</p>
        <hr>
        <p><strong>Expertise:</strong></p>
        <ul><li>Full-Stack Engineer</li><li>Python Developer</li><li>React Specialist</li></ul>`
    }
];
...
const aboutMeContent = {
    ...
    title: 'About Me',
    icon: ICONS.computer,
    content: `<h3>Jane Doe</h3>
    <p><strong>Full-Stack Engineer · Python Developer · React Specialist</strong></p>
    <hr>
    <p>Full-Stack Engineer specialized in React and Python. Refined through the Scientific Makeover process.</p>
    <button class="btn-win95" onclick="window.open('https://linkedin.com/in/janedoe', '_blank')">LinkedIn Profile</button>
    <button class="btn-win95" onclick="window.open('https://github.com/janedoe', '_blank')">GitHub</button>`
};

const folderMappings = {
    'web-dashboard': 'featured-projects',
    'ai-orchestrator': 'ai-labs',
};

const desktopItems = [
    { id: 'featured-projects', title: 'Featured Work', icon: ICONS.folder, isFolder: true, tooltip: 'Top technical achievements' },
    { id: 'ai-labs', title: 'AI Labs', icon: ICONS.brain, isFolder: true, tooltip: 'Experimental AI projects' },
